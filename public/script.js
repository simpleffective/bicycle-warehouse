...
const form = document.getElementById('add-bicycle-form')
...
const addButton = document.getElementById('list-bicycle-button')
...
const readerDisplay = reader.style.display;
reader.style.display = 'none';
const popup = document.getElementById('add-bicycle-popup')
